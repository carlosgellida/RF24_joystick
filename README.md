This branch have some troubles, mainly some data are lost at brieft time intervals, also It's not possible to use the maximum power of the radio. The structure of the loop is not 
